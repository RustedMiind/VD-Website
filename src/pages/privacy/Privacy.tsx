import image from "assets/images/privacy.jpg";
import PageBannerLayout from "pages/page-banner-layout/PageBannerLayout";

function PrivacyPage() {
  return (
    <PageBannerLayout data={{ bgImage: image, title: "PRIVACY POLICY" }}>
      <div className="privacy-page ltr">
        <div data-custom-class="body">
              ...
              <strong>
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="subtitle">
                    Last updated <span className="question">June 14, 2023</span>
                  </span>
                </span>
              </strong>
            </span>
              ...
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    ...
                    <span className="question">
                      <a
                        href="https://www.vd-2030.com/en"
                        target="_blank"
                        data-custom-class="link"
                      >
                        https://www.vd-2030.com/en
                      </a>
                    </span>
                    <span style={{ fontSize: "15px" }}>
                      <span style={{ color: "rgb(89, 89, 89)" }}>
            ...
            <span style={{ fontSize: "15px" }}>
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span data-custom-class="body_text">
                  ...
                  <span className="question">info@vision.com</span>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            <span style={{ fontSize: "15px" }}>
              <span data-custom-class="body_text">
                ...
                <span className="block-component" />
                <span className="question">VISION DIMENSIONS</span>
                <span className="statement-end-if-in-editor" /> and the
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            <a
              data-custom-class="link"
              href="https://app.termly.io/notify/72a64d8d-9677-453f-aed7-1ce6d9617c79"
          ...
          <ul>
            <li style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: "15px" }}>
                <span data-custom-class="body_text">
                  <span className="question">genetic data</span>
                </span>
              </span>
            </li>
          </ul>
          ...
          <ul>
            <li style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: "15px" }}>
                <span data-custom-class="body_text">
                  <span className="question">biometric data</span>
                </span>
              </span>
            </li>
          </ul>
          ...
          <ul>
            <li style={{ lineHeight: "1.5" }}>
              <span style={{ fontSize: "15px" }}>
                <span data-custom-class="body_text">
                  <span className="question">credit worthiness data</span>
                </span>
              </span>
            </li>
          </ul>
            ...
            <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
              <span style={{ fontSize: "15px", color: "rgb(89, 89, 89)" }}>
                <span data-custom-class="body_text">
                  ...
                  intent data (or user <span className="block-component" />
                  behavior
                  <span className="statement-end-if-in-editor" /> data),
                    ...
                    <li style={{ lineHeight: "1.5" }}>
                      <span style={{ fontSize: "15px" }}>
                        <span data-custom-class="body_text">
                          ...
                          information, see <span className="block-component" />"
                          <span className="statement-end-if-in-editor" />
                        </span>
                      </span>
                                ...
                                <li style={{ lineHeight: "1.5" }}>
                                  <span style={{ fontSize: "15px" }}>
                                    ...
                                    <span data-custom-class="body_text">
                                      ...
                                      obtain and store on your device (
                                      <span className="block-component" />
                                      "cache"
                                      <span className="statement-end-if-in-editor" />
                                      ) your location
                                      <span className="block-component" />. You
                                      may revoke your consent anytime by
                                      contacting us at the contact details
                                ...
                                <div style={{ lineHeight: "1.5" }}>
                                    ...
                                    <li style={{ lineHeight: "1.5" }}>
                                      <span data-custom-class="body_text">
                                        <span style={{ fontSize: "15px" }}>
                                          ...
                                          gifts, or other items to users in
                                          return for the acceptance and
                                          completion of an advertisement offer.
                                          Such an offer wall may appear in our
                                          application(s) and be displayed to you
                                          based on certain data, such as your
                                          geographic area or demographic
                                          information. When you click on an
                                          offer wall, you will be brought to an
                                          external website belonging to other
                                          persons and will leave our
                                          application(s). A unique identifier,
                                          such as your user ID, will be shared
                                          with the offer wall provider in order
                                          to prevent fraud and properly credit
                                    ...
                                    >
                                      ...
                                      >
                                        <span data-custom-class="body_text">
                                          ...
                                          of age. By using the Services, you
                                          ...
                                          users less than 18 years of age has
                                  ...
                                  <div style={{ lineHeight: "1.5" }}>
                                    <span style={{ fontSize: "15px" }}>
                                      <span data-custom-class="body_text">
                                        <span className="question">
                                          Saudi Arabia Jeddah Al Nahda District
                                          Al Safa Street Saudi Arabia Riyadh
                                          Al-Malaz
                                        </span>
                                        <span
                                          style={{ color: "rgb(89, 89, 89)" }}
                                  ...
                                  <div style={{ lineHeight: "1.5" }}>
                                    <span style={{ fontSize: "15px" }}>
                                      <span data-custom-class="body_text">
                                        <span className="question">Jeddah</span>
                                        <span
                                          style={{ color: "rgb(89, 89, 89)" }}
                                        >
                                          <span style={{ fontSize: "15px" }}>
